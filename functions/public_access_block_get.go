...
func PublicAccessBlockGet(c *cli.Context) (err error) {
	...
	input := new(s3.GetPublicAccessBlockInput)
	...
	// GetPublicAccessBlock Op
	var output *s3.GetPublicAccessBlockOutput
	if output, err = client.GetPublicAccessBlock(input); err != nil {
		return
	}
