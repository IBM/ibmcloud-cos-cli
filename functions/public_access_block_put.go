...
func PublicAccessBlockPut(c *cli.Context) (err error) {
	...
	input := new(s3.PutPublicAccessBlockInput)

	// Required parameters
	mandatory := map[string]string{
		fields.Bucket:                         flags.Bucket,
		fields.PublicAccessBlockConfiguration: flags.PublicAccessBlockConfiguration,
	}
	...
	// PutPublicAccessBlock Op
	var output *s3.PutPublicAccessBlockOutput
	if output, err = client.PutPublicAccessBlock(input); err != nil {
		return
	}
