...
func ObjectTaggingDelete(c *cli.Context) (err error) {
	...
	input := new(s3.DeleteObjectTaggingInput)
	...
	// DeleteObjectTagging Op
	var output *s3.DeleteObjectTaggingOutput
	if output, err = client.DeleteObjectTagging(input); err != nil {
		return
	}
