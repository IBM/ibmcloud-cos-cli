...
func PublicAccessBlockDelete(c *cli.Context) (err error) {
	...
	input := new(s3.DeletePublicAccessBlockInput)
	...
	// DeletePublicAccessBlock Op
	var output *s3.DeletePublicAccessBlockOutput
	if output, err = client.DeletePublicAccessBlock(input); err != nil {
		return
	}
