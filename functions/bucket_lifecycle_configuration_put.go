...
func BucketLifecycleConfigurationPut(c *cli.Context) (err error) {
	...
	input := new(s3.PutBucketLifecycleConfigurationInput)

	// Required parameters
	mandatory := map[string]string{
		fields.Bucket:                 flags.Bucket,
		fields.LifecycleConfiguration: flags.LifecycleConfiguration,
	}
	...
	if output, err = client.PutBucketLifecycleConfiguration(input); err != nil {
		return
	}
