...
func BucketVersioningPut(c *cli.Context) (err error) {
	...
	input := new(s3.PutBucketVersioningInput)

	// Required parameters
	mandatory := map[string]string{
		fields.Bucket:                  flags.Bucket,
		fields.VersioningConfiguration: flags.VersioningConfiguration,
	}
	...
	// PutBucketVersioning Op
	var output *s3.PutBucketVersioningOutput
	if output, err = client.PutBucketVersioning(input); err != nil {
		return
	}
