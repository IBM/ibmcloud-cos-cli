...
func BucketVersioningGet(c *cli.Context) (err error) {
	...
	input := new(s3.GetBucketVersioningInput)
	...
	// GetBucketVersioning Op
	var output *s3.GetBucketVersioningOutput
	if output, err = client.GetBucketVersioning(input); err != nil {
		return
	}
