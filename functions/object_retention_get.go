...
func ObjectRetentionGet(c *cli.Context) (err error) {
	...
	input := new(s3.GetObjectRetentionInput)
	...
	// GetObjectRetention Op
	var output *s3.GetObjectRetentionOutput
	if output, err = client.GetObjectRetention(input); err != nil {
		return
	}
