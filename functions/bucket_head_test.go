...
func TestBucketHeadSunnyPath(t *testing.T) {
	...
	// --- Act ----
	// set os args
	os.Args = []string{"-", commands.HeadBucket, "--bucket", targetBucket, "--region", "REG"}
	//call plugin
...
func TestBucketHeadRainyPath(t *testing.T) {
	...
	// --- Act ----
	// set os args
	os.Args = []string{"-", commands.HeadBucket, "--bucket", targetBucket,
		"--region", "REG"}
	//call plugin
	plugin.Start(new(cos.Plugin))
...
func TestBucketHeadWithoutBucket(t *testing.T) {
	...
	// --- Act ----
	// set os args
	os.Args = []string{"-", commands.HeadBucket,
		"--region", "REG"}
	//call plugin
	plugin.Start(new(cos.Plugin))
