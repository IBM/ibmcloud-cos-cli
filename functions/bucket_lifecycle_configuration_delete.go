...
func BucketLifecycleConfigurationDelete(c *cli.Context) (err error) {
	...
	input := new(s3.DeleteBucketLifecycleInput)
	...
	if output, err = client.DeleteBucketLifecycle(input); err != nil {
		return
	}
