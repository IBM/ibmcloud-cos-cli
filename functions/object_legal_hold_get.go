...
func ObjectLegalHoldGet(c *cli.Context) (err error) {
	...
	input := new(s3.GetObjectLegalHoldInput)
	...
	// GetObjectLegalHold Op
	var output *s3.GetObjectLegalHoldOutput
	if output, err = client.GetObjectLegalHold(input); err != nil {
		return
	}
