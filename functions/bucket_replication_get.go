...
func BucketReplicationGet(c *cli.Context) (err error) {
	...
	input := new(s3.GetBucketReplicationInput)
	...
	// GetBucketReplication Op
	var output *s3.GetBucketReplicationOutput
	if output, err = client.GetBucketReplication(input); err != nil {
		return
	}
