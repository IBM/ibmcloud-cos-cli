...
func ObjectLockPut(c *cli.Context) (err error) {
	...
	input := new(s3.PutObjectLockConfigurationInput)

	// Required parameters
	mandatory := map[string]string{
		fields.Bucket:                   flags.Bucket,
		fields.ObjectLockConfiguration:  flags.ObjectLockConfiguration,
	}
	...
	if output, err = client.PutObjectLockConfiguration(input); err != nil {
		return
	}
