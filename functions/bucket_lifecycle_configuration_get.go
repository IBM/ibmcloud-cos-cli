...
func BucketLifecycleConfigurationGet(c *cli.Context) (err error) {
	...
	input := new(s3.GetBucketLifecycleConfigurationInput)
	...
	// GetBucketLifecycleConfiguration Op
	var output *s3.GetBucketLifecycleConfigurationOutput
	if output, err = client.GetBucketLifecycleConfiguration(input); err != nil {
		return
	}
